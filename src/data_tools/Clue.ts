export const clues: {[index: string]:any} = {
    "1": {
        "places": {
            "221B": ['There is no clue here, and you cannot', 'solve the case without a BADGE.'],
        ...
        "explenation":[
         ...
         "from himself; but in the process, he accidentally dropped his packet of aspirin."
        ]
        ,
        "quiz":{
            "0":["The Bishop", "Duke Tallcourt", "Earl Longworth", "Duchess Tallcourt"],
            "1":["Knife", "Sword", "Rope", "Poison"],
            "3":["Manuscript", "Jealousy", "Revenge", "Insurance"]
        },
        "answers": [3, 2, 1]
    }
}